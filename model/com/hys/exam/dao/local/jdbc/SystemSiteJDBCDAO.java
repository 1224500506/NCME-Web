...
public class SystemSiteJDBCDAO extends AbstractJDBCDAO implements SystemSiteDAO {
	...
	public Integer save(SystemSite item) {
		...
		getNamedParameterJdbcTemplate().update(addSystemSite_SQL,
	...
	public int saveSystemCardTypeSite(Long typeId, Long siteId){
		...
		return this.getJdbcTemplate().update(sql, typeId, siteId);
	}
	
	@Override
	public int deleteSystemCardTypeSite(Long typeId, Long siteId){
		return this.getJdbcTemplate().update("delete system_card_type_site t where t.cardtype_id = ? and t.site_id = ?", typeId, siteId);
	}
	...
	public int deleteSystemSiteOrgan(Long siteId, Long organId){
		return this.getJdbcTemplate().update("delete system_site_organ t where t.site_id = ? and t.organ_id = ?", siteId, organId);
	}
	...
	public int deletePaycardOrgan(Long typeId, Long organId){
		return this.getJdbcTemplate().update("delete system_paycard_organ t where t.card_type_id = ? and t.org_id = ?", typeId, organId);
	}

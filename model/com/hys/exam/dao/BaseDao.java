...
//        return this.queryForLong(key, sql);
     ...
     * @return Long
     */
    public Long queryForLong2( String sql ,Long params) throws SQLException {
    	if (params!=0) {
    		return this.queryForLong2(sql, params);
		}else {
    ...
    public String queryForString2(String key, int params ,String sql) throws SQLException {
       if (params==0) {
		return this.queryForString2(key, params, sql);
	}else{
        return this.queryForString2(key, params, sql);
	}
    }
   ...
   /* @SuppressWarnings("unchecked")
    ...
    public int queryForInt(String sql, String params, String key) throws SQLException {
        if (params == null || params== "") {
            return jdbcTemplate.queryForInt(sql, key,params);
        } else {
         return jdbcTemplate.queryForInt(sql, params, key);
        }

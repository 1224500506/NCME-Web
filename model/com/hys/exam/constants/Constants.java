...
public class Constants {
	...
	public static final String UPLOAD_FILE_PATH_ORG = "../storage/upload/Org";
	public static final String UPLOAD_FILE_PATH_ORG_PHOTO = "../peixun/upload/Org";
	public static final String UPLOAD_FILE_PATH_USER = "/storage/upload/USER"; //"../storage/upload/USER"; YHQ 2017-02-20
...
//	public static final String TABLE_EXAM_QUESTION_QUEST_LIB = "EXAM_QUESTION_QUEST_LIB";
	...
	public static String[] RESULT = {"A","B","C","D","E","F","G","H","I","J","K","L","M"};
	...
	public static final Long AJPX_SYSTEM_SITE_ID = 24L;		//安监培训站点ID
	...
	//添加认证用户signK
	public static final String SESSION_TRAIN_ADMIN_SIGNK = "SESSION_TRAIN_ADMIN_SIGNK";

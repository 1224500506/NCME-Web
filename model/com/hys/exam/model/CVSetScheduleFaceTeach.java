...
public class CVSetScheduleFaceTeach  implements Serializable {
    ...
    private String class_name;//面授期数
    private Integer people_number;

    private Date train_starttime;//项目开始时间
    private Date train_endtime; //项目结束时间

    private String lession_starttime;//上课开始时间
    private String lession_endtime;//上课接受时间
    private String train_place;//面授地址
    private String contact_way;//聯繫方式
    private String route_way;//线路
	
	private String trainStartTime ;//格式化显示而已
	private String trainEndTime ; //格式化显示而已
	
	private Integer faceType;//面授类型 【2面授中 1未开始 3已结束 】
	
	private Integer id; //面授Id

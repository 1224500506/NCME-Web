package com.hys.exam.struts.action.fileup;
...
import com.hys.exam.struts.form.FileUploadForm3;
...
//zhegejishhi 
public class FileUploadAction3 extends BaseAction
{
...
protected String actionExecute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
	...
	throws Exception{
    FileUploadForm3 fileUploadForm = (FileUploadForm3)form;
    FormFile file = fileUploadForm.getMatFile3();
...
//    	newFile.mkdir(); 
    ...
    try {
		...
		System.out.println("FileUploadAction-----" + e);
		map.put("message", "Fail"); 
	}
    //newFile.delete();

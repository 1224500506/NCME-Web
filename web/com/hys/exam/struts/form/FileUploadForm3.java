...
public class FileUploadForm3 extends BaseForm {
    ...
    private FormFile matFile3;     //上传文件
	...
	public FormFile getMatFile3() {
		return matFile3;
	}

	public void setMatFile3(FormFile matFile3) {
		this.matFile3 = matFile3;
	}

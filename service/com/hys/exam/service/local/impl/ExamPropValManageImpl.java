...
public class ExamPropValManageImpl extends BaseMangerImpl implements
	...
	public List<ExamProp> getNewPropListByType(ExamProp prop) {
		return localExamPropValDAO.getNewPropListByType(prop);
	}
	...
	@Override
	public void updatReplaceQuestionPropVal(Long targetId, Long propId,
			Integer type) {
		ArrayList<ExamQuestionPropValCascade> cascadeList = new ArrayList<ExamQuestionPropValCascade>();
		Map<String,List<ExamQuestionProp>> questionPropMap = new HashMap<String,List<ExamQuestionProp>>();
	...
	public List<ExamICD> getIcdListByType(ExamICD prop) {
		return localExamPropValDAO.getIcdListByType(prop);
	}
	...
	public List<ExamHospital> getHospitalListAll(ExamHospital host) {
		return localExamPropValDAO.getHospitalListAll(host);
	}
	
	@Override
	public List<ExamHospital> getHospitalDistrict(ExamHospital host) {
		return localExamPropValDAO.getHospitalDistrict(host);
	}
	
	@Override
	public List<ExamHospital> getHospital(Long id) {
		return localExamPropValDAO.getHospital(id);
	}
	...
	public ExamReturnProp getNextLevelPropExam(ExamPropQuery propQuery) {
		return localExamPropValDAO.getNextLevelPropExam(propQuery);
	}

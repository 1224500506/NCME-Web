...
public class ESUtil {
	...
	public static String getUpdateFileDownloadUrl(String filePath,String bucketName,String sourceKey) throws Exception{
		Map<String,Object> map = new HashMap<String,Object>();
		...
		///Object名称(必选)
		map.put("sourceKey", sourceKey);
		String res = ESConnUtil.ESConn(ESConfig.UPDATE_FILE, map); 
		return res;
	}

...
<!--                                     	<span class="font_green" style="float:left;">收费</span> -->
				...
				<c:forEach items="${CVList}" var="muke" varStatus="SerialNumber">
			            ...
			            <span class="item_cover"
	                        ...
	                        <div class="item_title">
		                        ...
		                        <fmt:formatDate value="${muke.endDate}"  pattern="HH:mm"/></span>	                        </div>
	...
	<!--                                     	<span class="font_green" style="float:left;">收费</span> -->
		...
		<div class="content no_padding" style="display:none;">
			<div class="DynamicInformation_title">
				<h2>面授课程</h2>
				<%--
				<a href="#">更多></a>
			...
			<div class="face-to-face">
					...
					<ul>
						<%--
						<li><span>培训时间：</span><p>2017-06-01 ~2017-06-30</p></li>
						<li><span>培训地点：</span><p>山西大学</p></li>
						<li><span>培训内容：</span><p>面授班次001</p></li>
						<li><span>面授名额：</span><p>100人</p></li>
						<li><span>联系方式：</span><p> 张硕：13529089102</p></li>
						 --%>
					</ul>
				</div>

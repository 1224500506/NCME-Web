						...
						<c:choose>
                			<c:when test="${SentenceList!= null && fn:length(SentenceList) > 6}">
                				<c:forEach items="${SentenceList}" var="Sentence"  begin="0" end="5" step="1">
									<li onclick="window.open('${ctx}/DynamicNotice.do?id=${Sentence.id}','_self')">${Sentence.title}<span>|</span>
	...
	<!--                                     	<span class="font_green" style="float:left;">收费</span> -->
		...
		<div class="content no_padding">
			...
			<div class="face-to-face">
				...
				<div style="clear:both;"></div>
				<ul>
					<li><span>培训时间：</span><p>2017-05-18~2017-05-19</p></li>
					<li><span>培训地点：</span><p>武警山西总队招待所</p></li>
					<li><span>培训内容：</span><p>见课程表</p></li>
					<li><span>面授名额：</span><p>50人</p></li>
					<li><span>联系方式：</span><p>魏小刚&nbsp;&nbsp;手机：13911574318</p><p class="add">赵智雄&nbsp;&nbsp;手机：18234031188</p></li>
				</ul>
			</div>
...
<!-- 	结束		实现好的免受课程，数据不完整暂时屏蔽 -->	
		...
		<div class="content no_padding">
			...
			<table class="table">
				...
				<tr>
					<td rowspan="5">5月18日（周四）</td>
					<td>08:30-10:00</td>
					<td>社区公共服务能力实践</td>
					<td>北京月坛社区卫生服务中心   董建琴教授</td>
				</tr>
				<tr>
					<td>10:10-12:00</td>
					<td>乡医教学十八讲</td>
				...
				<tr>
					<td>13:30-15:00</td>
					<td>糖尿病的规范化诊治</td>
					<td>山西医科大学第一医院内分泌科杨静教授</td>
				</tr>
				<tr>
					<td>15:00-16:30</td>
					<td>发热原因待查</td>
					<td>山西大医院风湿免疫科  张莉芸教授</td>
				</tr>
				<tr>
					<td>16:40-18:00</td>
					<td>常见疾病的院前急救及转诊原则</td>
					<td>山西大医院全科医学科  冯玫教授</td>
				</tr>
				<tr>
					<td rowspan="4">5月19日（周五）</td>
					<td>08:00-10:00</td>
					<td>健康教育在慢病管理中的应用</td>
					<td>山西省人民医院社区卫生指导中心  黄立坤教授</td>
				</tr>
				<tr>
					<td>10:10-12:00</td>
					<td>慢性心率衰竭规范化诊疗技能</td>
					<td>山西医科大学第二医院心内科  杨志明教授</td>
				</tr>
				<tr>
					<td>13:30-15:30</td>
					<td>常见高血压病的规范化诊疗</td>
					<td>山西省人民医院心内科  张虹教授</td>
				</tr>
				<tr>
					<td>15:40-17:30</td>
					<td>传染病防治基本知识</td>
					<td>山西医科大学第一医院感染病科  张缭云教授</td>
				</tr>

...
<body>
<form name="BasicSubject" id = "BasicSubject" action="${ctx}/BasicSubject.do" method="post">
<div class="container">  
    ...
    <div class="filter_cont">
        ...
        <ul>
            <li>类型：</li>
            <li class="item_list">
                <span id="sign1" onclick = "javascript:selSign(-1);"  class = "<c:if test="${sign == -1 || sign eq null}">active</c:if>">全部</span>
    ...
    <div class="content top_border">
        <div class= "main_cont" >
        <display:table id="item" name="CVSet" requestURI="${ctx}/PublicSubject.do"
            ...
            <% Integer k = 1; %>
               <c:forEach items = "${cvEditionList}" var = "edition">
	               ...
	               <li onclick = "javascript:gotoDetail(${edition.id });">
	                    <span class="item_cover" style="background:url(${edition.file_path}) no-repeat center;background-size:cover">

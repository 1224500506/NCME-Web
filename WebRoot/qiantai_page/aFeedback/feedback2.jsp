 	    ...
 	    <div class="comment_form" style="position: relative" >
            ...
            <form class="join_form inline_form" action="" method="post" enctype="multipart/form-data" name="feedbackFrom" id="uploadForm">
                   ...
                   <div class="fk_tit">
                       ...
                       <textarea name="contnet" class="comment_cont liuyan"></textarea>
                   </div>
                                ...
                                <div class="z_photo upimg-div clear">
                                    <div class="upimg_sec">
                                        <section class="z_file">
                                            <span>上传图片</span>
                                            <input type="file" name="matFile" id="file" class="file up_img" value="" />
                                        </section>
                                    </div>
                                </div>
                            </section>
                ...
                <!-- <div class="input_div" style="height: 32px;" align="left">
                
                    <label style="text-align: left">手机号：</label><br><br>
                    <input type="text" name="telphone" id="tel" class="max_w user_id" placeholder="登录后自动提取账号手机号" size="22" style="width: 400px;"> 
                </div> -->
									...
									var v1 = JSON.parse(data1).message;
									 ...
									 if(v1!="Fail"){
    			            			 ...
    			            			 var urll="";
    			            				 ...
    			            				 urll='${ctx}/feedback/feedbackManage.do?method=fileUp';
...
<%-- <script src="${ctx}/qiantai_page/aFeedback/feedback/js/imgUp.js"></script> --%>

        ...
        <div class="tabs">
            ...
            <div class="tab2 tab_cont" style="display:none">
                <div class="tabs tag_tabs">
                    ...
                    <div class="tab6 tab_cont" style="display:none">
                        <div class="half_cont">
                            <ul>
                               <li>神经系统：
                    ...
                    <div class="tab7 tab_cont" style="display:none">
		                  <p>化验：${caseData.caseDiseaseObject.assay}</p>
		                  <p>影像学：${caseData.caseDiseaseObject.image}</p>
		                  <p>其他：${caseData.caseDiseaseObject.rest}</p>
                    </div>
                    ...
                    <div class="tab9 tab_cont" style="display:none">
                        <p>治疗方案：${caseData.caseDiseaseObject.plan}</p>
                    </div>
            ...
            <div class="comment_top">
                <h1 class="main_title_2">讨论点</h1>
            </div>
            <div class="news_cont clearfix" style="width:100%;padding:0">
                <div class="top_cont" style="background-color:#f0f0f0;border-bottom:0;margin-bottom:30px;padding:20px">
                    <h1 style="text-align:left;margin:0;font-size:16px;padding:0">临床实验中，您认为有哪些措施能够更好的预防或处理白内障手术并发症？</h1>
                    <h3 style="text-align: left;margin:0;padding:0;font-size:12px">
                    ...
                    <div>
                        ...
                        <span class="go_comment btn btn_small" style="cursor:pointer;color:#333"><i class="fa fa-edit"></i> 去讨论 </span>
                    </div>
                    <div class="comment_form" style="display:none">
                        <textarea name="comment_cont" class="comment_cont"></textarea>
                        <div class="foot">
                            <button name="comment_submit" id="comment_submit_left" type="button" class="btn btn_orange btn_small">评论</button>
                            <span class="text_count">还能输入<span class="num_count">200</span>字</span>
                        </div>
                    </div>
                    <h3 class="reply_title" style="font-size:14px;border-bottom:1px solid #333;font-weight:bold">共6条回复</h3>
   ...
   function courseTestTime(_id,obj) {
    ...
    //add 笔记  to DB; M
     ...
     //end;M
       ...
       $(function () {
        $(".go_comment").click(function(){
            $(this).parent().parent().find(".comment_form,.comments_list,.reply_title").show();
            $(this).parent().parent().siblings().find(".comment_form,.comments_list,.reply_title").hide();

...
<div class="container">
    <div class="course_video" style="position:relative;">
       ...
       <div class="box">
        ...
        <div id="preview" style="width:100%;height:calc(100% - 100px);background:#000;color:#FFF;margin-top:100px;box-sizing:border-box;  text-align: center;">
            <!-- 封面信息 -->
...
<script>
 ...
 // var peixunURL = "http://localhost:8081/test_peixun";
    ...
    $(window).bind('beforeunload',function () {  	     
       ...
       projectCensus();//在离开页面时更新下该项目的学习记录-----taoliang
	}) ; 
	...
	*/
    ...
    function projectCensus(){
		$.ajax({
			type: 'POST',
			url: ctxJS + "/study/logstudy.do?mode=projectCensus&cvSetId="+currCvSetIdVal,
			dataType: 'JSON',
			success : function(result){
			}
    	})

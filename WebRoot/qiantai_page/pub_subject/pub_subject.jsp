...
<body>
<form name="PubSubject" id = "PubSubject" action="${ctx}/PublicSubject.do?sign=1" method="post">
<div class="container">  
	<%@include file="/qiantai_page/top2.jsp"%>
    <ul class="bread_crumbs">
       <li>您的位置：</li>
       <li><a href="${ctx}/first.do">首页</a> <i class="fa fa-angle-right"></i></li>
       <li><a href="${ctx}/PublicSubject.do?sign=1">公需科目</a></li>
    </ul>
    <div class="filter_cont">
        <ul>
            <li>级别：</li>            
            <li class="item_list">
                <span id="level0" onclick = "javascript:selLevel(-1);" class="all <c:if test="${level == -1}">active</c:if>">全部</span>
    ...
    <div class="content top_border">
        <div class= "main_cont">
        <display:table id="item" name="CVSet" requestURI="${ctx}/PublicSubject.do?sign=1"
					decorator="com.hys.exam.displaytag.OverOutWrapper" class = "myTable" excludedParams="msg" pagesize="10">				
				<display:caption>
					<ul class="item_filter">
               		   <li class="search">
               			    <input type="text" id="item_name" name="item_name" value="${ItemName}" placeholder="请输入课程名称">
				...
				<display:column>
					...
					<li>
	                    ...
	                    <div class="item_cont">
	                        ...
	                        <input type="hidden" id="idVal" name="idVal" value="${item.id}"/>
	                     </div>
	                     </a>
	                </li>
	                </ul>
